...
//         {
//             Console.WriteLine($"{item.Category.Name}: {category.Count}");}

// .2
// var prod = productions.GroupBy(e=>e.Category).Select(e=> new{ Category = e.Key,Count = e.Count()});
...
// var prod = productions.GroupBy(e=>e.Category).Select(e=> new { Category = e.Key, Average = e.Average(p=>p.Price)});

// foreach (var item in prod)
// {
//     System.Console.WriteLine($"Average {item.Category.Name} {item.Average:C}");
// }
...
// var prod = productions.GroupBy(e=>e.Category).Select(e=> new {Category = e.Key, Max = e.Max(e=>e.Price)});

// foreach (var item in prod)
// {
//     System.Console.WriteLine($"Average {item.Category.Name} {item.Max}");
// }